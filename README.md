...
このブランチには観察シミュレーションも含まれます。同居・受容・住居準備・猫の適応の定義と、DAY1〜3のデモ導入は [STATE_MODEL.md](STATE_MODEL.md) を参照してください。以下は候補抽出テストの説明です。

調査・工作各3種類と1日1回の操作ルールは [NNN_ACTIONS.md](NNN_ACTIONS.md) を参照してください。
